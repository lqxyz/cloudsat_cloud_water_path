...
if __name__ == '__main__':
    ...
    for year in range(2012, 2015):
        ...
        visit_num = ds.visit_num #yearly_sum(ds.visit_num)
        ...
        lwp_sum = ds.lwp_sum #yearly_sum(ds.lwp_sum)
        ...
        iwp_sum = ds.iwp_sum #yearly_sum(ds.iwp_sum)
        ...
        #ds_out = xr.Dataset({'lwp':lwp, 'iwp':iwp, 'cwp':cwp, 'lwp_gm':lwp_gm.values,
        #    'iwp_gm':iwp_gm.values, 'cwp_gm':cwp_gm.values }, coords={'year':np.array(year), 'lat':ds.lat, 'lon':ds.lon})
